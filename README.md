...
> **Tip:** Type `start` as your first message each session. Claude will run the full session-start checklist step-by-step and announce each item so you can verify compliance.
