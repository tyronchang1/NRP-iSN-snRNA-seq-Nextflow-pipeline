...
If you are in the rmlab group on HTCF, these are already at `/ref/rmlab/software/` and the default paths will work. If you are on a different account or cluster, install them yourself and update the paths in step 2.
